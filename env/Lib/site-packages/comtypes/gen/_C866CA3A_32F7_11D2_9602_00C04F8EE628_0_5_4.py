...
__all__ = [
    'DISPID_SLWs_NewEnum', 'DISPID_SLPPhoneIds',
    'DISPID_SPRules_NewEnum', 'DISPIDSPTSI', 'SPCATEGORYTYPE',
    'SpeechAudioProperties', 'STSF_FlagCreate',
    'DISPID_SRRPhraseInfo', 'DISPID_SDKSetStringValue',
    'ISpRecoGrammar2', 'SPRS_ACTIVE', 'SAFT48kHz8BitMono',
    'SVEAudioLevel', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechDataKey', 'SpeechTokenShellFolder',
    'SpeechWordPronounceable', 'SPEI_RESERVED5', 'SPWF_SRENGINE',
    'DISPID_SRGId', 'SpStream', 'DISPID_SRGDictationSetState',
    'SpMemoryStream', 'SPLOADOPTIONS', 'ISpeechMMSysAudio',
    'DISPID_SRCreateRecoContext', 'SVP_11', 'ISpEventSource',
    'SVP_20', 'DISPID_SPRDisplayAttributes', 'ISpStream',
    'DISPID_SPIAudioSizeBytes', 'SGSDisabled', 'ISpeechXMLRecoResult',
    'SAFT8kHz16BitMono', 'DISPID_SPELexicalForm', 'SPSSuppressWord',
    'SPPS_Interjection', 'DISPID_SPIStartTime', 'SREAdaptation',
    'DISPID_SPRuleChildren', 'DISPID_SRProfile', 'eLEXTYPE_RESERVED7',
    'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFT8kHz16BitStereo',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechFormatType',
    'ISpeechBaseStream', 'SPEVENTENUM', 'SPEI_SR_PRIVATE',
    'DISPID_SGRSAddRuleTransition', 'SpeechStreamSeekPositionType',
    'SpCustomStream', 'SpeechGrammarWordType', 'SFTSREngine',
    'SRERecoOtherContext', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPIAudioStreamPosition', 'SVSFIsXML',
    'SAFT32kHz16BitMono', 'DISPID_SABIMinNotification',
    'SVSFIsNotXML', 'DISPID_SVSVisemeId', 'DISPID_SVSpeak',
    'DISPID_SVSLastResult', 'SpeechTokenValueCLSID',
    'SPEI_ADAPTATION', 'DISPID_SLPPartOfSpeech',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SRCResume', 'ISpeechAudioFormat', 'SpLexicon',
    'DISPID_SpeechBaseStream', 'ISpeechAudioStatus',
    'SPDATAKEYLOCATION', 'eLEXTYPE_PRIVATE7',
    'ISpeechPhraseAlternate', 'SpeechVisemeFeature',
    'DISPID_SASCurrentDevicePosition', 'SAFT22kHz8BitMono',
    'SAFT32kHz8BitStereo', 'DISPID_SVVoice', 'SSTTWildcard',
    'DISPID_SRRSaveToMemory', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SPAPhraseInfo', 'DISPID_SRGReset', 'ISpRecognizer2',
    'SASPause', 'eLEXTYPE_PRIVATE6', 'ISpeechRecoResultDispatch',
    'ISpPhoneConverter', 'SVSFParseMask', 'SpPhoneConverter',
    'SVPOver', 'SSTTDictation', 'SpeechCategoryAudioOut',
    'DISPID_SpeechAudioBufferInfo', 'SGDSActive', 'SPPS_SuppressWord',
    'SpeechAudioFormatGUIDWave', 'SAFTADPCM_44kHzStereo', 'SDTAudio',
    'SPPS_RESERVED2', 'SPADAPTATIONRELEVANCE',
    'DISPID_SpeechRecognizer', 'DISPID_SLPLangId',
    'DISPID_SpeechPhraseElement', 'DISPID_SAEventHandle',
    'STCLocalServer', 'SDKLLocalMachine', 'ISpeechPhraseElements',
    'SRTEmulated', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechVoice',
    'SPINTERFERENCE_TOOFAST', 'SpeechCategoryVoices',
    'DISPID_SRCAudioInInterferenceStatus', 'SVSFUnusedFlags',
    'ISpObjectToken', 'DISPID_SVAudioOutput',
    'DISPID_SPIReplacements', 'DISPID_SMSGetData',
    'DISPID_SpeechRecoContext', 'DISPID_SLAddPronunciation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SGDSInactive',
    'SSSPTRelativeToStart', 'SpeechPartOfSpeech',
    ...
    'SpeechVoicePriority', 'SP_VISEME_21', 'SRCS_Enabled',
    'ISpRecognizer', 'SPGS_DISABLED', 'DISPID_SOTId',
    'eLEXTYPE_RESERVED6', 'SPRULE', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SBSSeek',
    'SSFMCreateForWrite', 'DISPID_SpeechPhraseReplacement',
    'SPGRAMMARWORDTYPE', 'SpeechAddRemoveWord',
    'SpeechStreamFileMode', 'DISPID_SPAsCount',
    'SAFTExtendedAudioFormat', 'SAFT16kHz16BitStereo',
    'SAFT22kHz16BitMono', 'DISPID_SABufferNotifySize',
    'DISPID_SPAsItem', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPEI_END_INPUT_STREAM', 'ISpeechFileStream',
    'DISPID_SRCERecognizerStateChange', 'SP_VISEME_18',
    'SDKLCurrentConfig', 'SPPS_RESERVED1',
    'SpeechRetainedAudioOptions', 'SRTStandard',
    'SPPHRASEREPLACEMENT', 'SpeechRuleState',
    'SGDSActiveUserDelimited',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SGRSTransitions',
    'SGRSTTWord', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPSNoun', 'DISPID_SRRTimes', 'SP_VISEME_14',
    'DISPID_SpeechLexiconWords', 'DISPID_SPRs_NewEnum', 'SVSFDefault',
    'DISPID_SpeechMMSysAudio', 'DISPID_SOTCDefault',
    'DISPID_SVEViseme', 'SPSHT_Unknown', 'DISPID_SPEEngineConfidence',
    'SGRSTTTextBuffer', 'SpeechVisemeType', 'SAFT48kHz8BitStereo',
    'ISpeechVoiceStatus', 'SP_VISEME_6', 'DISPID_SRSetPropertyString',
    'DISPID_SRGCommit', 'SPVPRI_OVER', 'ISpRecoContext',
    'DISPID_SAFGetWaveFormatEx', 'SpNullPhoneConverter',
    'ISpeechLexicon', 'DISPID_SRGState', 'DISPID_SDKGetBinaryValue',
    'SAFT24kHz8BitStereo', 'SREHypothesis', 'DISPID_SMSALineId',
    'DISPID_SOTDataKey', 'SAFT24kHz16BitMono',
    'DISPID_SVWaitUntilDone', 'DISPID_SLWsItem', 'SpResourceManager',
    'SAFTNoAssignedFormat', 'SAFTCCITT_uLaw_22kHzStereo', 'SPAS_STOP',
    'ISpeechGrammarRuleState', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVGetVoices', 'STCAll', 'SPFILEMODE',
    'SPSHT_NotOverriden', 'SPSInterjection', 'SPPS_Noncontent',
    'SP_VISEME_12', 'SPPHRASERULE', 'DISPID_SRDisplayUI',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_RESERVED6', 'SPPHRASE',
    'Speech_Max_Pron_Length', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SPPsItem', 'SPPS_RESERVED4',
    'SDTAlternates', 'eLEXTYPE_PRIVATE2', 'SPINTERFERENCE_NOISE',
    'SPWORDPRONUNCIATIONLIST', 'SPINTERFERENCE', 'SVEVoiceChange',
    ...
    'DISPID_SPPChildren', 'DISPID_SpeechGrammarRules',
    'DISPID_SGRSTsItem', 'ISpeechDataKey',
    'SAFTCCITT_uLaw_8kHzStereo', 'SVPNormal',
    'ISpeechTextSelectionInformation', 'DISPID_SRRAudio',
    'DISPID_SGRsCommit', 'SpeechVoiceEvents',
    'SpeechPropertyAdaptationOn', 'SAFTGSM610_44kHzMono',
    'SpMMAudioIn', 'ISpeechPhraseInfoBuilder', 'DISPID_SLWType',
    'SPAR_High', 'DISPID_SVESentenceBoundary', 'SVEViseme',
    'SP_VISEME_19', 'DISPID_SPARecoResult', 'DISPID_SPRText',
    'SAFT12kHz8BitStereo', 'ISpeechRecoContext',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPRECOSTATE',
    'eLEXTYPE_RESERVED9', 'SpObjectToken', 'DISPID_SRRTTickCount',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RESERVED3',
    'DISPID_SPEDisplayText', '_SPAUDIOSTATE',
    'DISPID_SRGIsPronounceable', 'SPEI_MAX_SR', 'SPVISEMES',
    'DISPID_SGRId', 'DISPID_SGRAddResource', 'SREPropertyNumChange',
    'SVEPrivate', 'SPEI_HYPOTHESIS',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SAFGuid',
    'DISPID_SPIEnginePrivateData', 'WAVEFORMATEX',
    'DISPID_SVSInputWordLength', 'ISpeechObjectTokens',
    'DISPID_SRCCmdMaxAlternates', 'SPAO_RETAIN_AUDIO',
    'SWPUnknownWordUnpronounceable', 'SDA_Consume_Leading_Spaces',
    'DISPID_SGRSTPropertyName', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpProperties', 'ISpRecoContext2',
    'DISPID_SPERequiredConfidence', 'SVP_17',
    'DISPID_SOTGetDescription', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRCPause', 'SITooLoud', 'SPGRAMMARSTATE',
    'tagSPPROPERTYINFO', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SpeechObjectTokens',
    'DISPID_SpeechPhraseProperty', 'DISPID_SGRAttributes',
    'DISPID_SLWPronunciations', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCEHypothesis', 'ISpeechRecognizerStatus',
    'DISPID_SASState', 'DISPID_SWFEFormatTag', 'DISPID_SRStatus',
    'DISPID_SPPConfidence', 'DISPID_SRCRetainedAudio',
    'ISequentialStream', 'SECFDefault', 'DISPID_SLPSymbolic',
    'ISpStreamFormat', 'DISPID_SPEs_NewEnum', 'SPXMLRESULTOPTIONS',
    'ISpRecoGrammar', 'SAFT11kHz16BitStereo', 'SAFT44kHz16BitMono',
    'SpStreamFormatConverter', 'DISPID_SRCEPhraseStart',
    'DISPID_SPPs_NewEnum', 'DISPID_SpeechGrammarRule', 'SGDisplay',
    'SITooFast', 'DISPID_SGRClear', 'SAFTNonStandardFormat', 'SPWORD',
    'SRAORetainAudio', 'DISPID_SPAs_NewEnum', 'ISpPhraseAlt',
    'ISpeechPhraseInfo', 'SECFIgnoreCase', 'STCInprocHandler',
    'SRTAutopause', 'DISPID_SVIsUISupported', 'DISPID_SBSWrite',
    'DISPID_SRState', 'ISpXMLRecoResult', 'DISPID_SPRsItem',
    'DISPID_SVEStreamEnd', 'DISPID_SPPId', 'SVP_1',
    'DISPID_SVSCurrentStreamNumber', 'SGDSActiveWithAutoPause',
    'SAFT12kHz16BitMono', 'eLEXTYPE_RESERVED4', 'DISPID_SLGetWords',
    'SAFTDefault', 'SWTAdded', 'SPRST_INACTIVE_WITH_PURGE',
    'SP_VISEME_15', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpNotifySink',
    'SECNormalConfidence', 'SRCS_Disabled', 'SPWT_PRONUNCIATION',
    'SpSharedRecoContext', 'SPXRO_SML', 'DISPID_SVPriority',
    'SPDKL_CurrentUser', 'SVP_18', 'SREPhraseStart',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechWaveFormatEx',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SDKGetlongValue', 'SVPAlert',
    'SLOStatic', 'ISpeechMemoryStream', 'DISPID_SLPsItem',
    'DISPID_SPEsItem', 'SGLexicalNoSpecialChars', 'SPEI_MIN_SR',
    'SDTDisplayText', 'DISPID_SRAudioInput', 'SVSFPersistXML',
    'ISpeechPhraseRule', 'DISPID_SPILanguageId', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRSTType', 'eLEXTYPE_PRIVATE9', 'DISPID_SGRSTRule',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVEStreamStart',
    'ISpeechResourceLoader', 'SLODynamic', 'DISPID_SLGenerationId',
    'SP_VISEME_10', 'DISPID_SRGetPropertyString', 'DISPID_SPIGetText',
    'SRTSMLTimeout', 'DISPID_SRGetPropertyNumber', 'SP_VISEME_1',
    'SPLEXICONTYPE', 'SAFT44kHz8BitMono', 'DISPID_SOTCId',
    'DISPID_SRRTOffsetFromStart', 'SpeechGrammarTagWildcard',
    'SpInprocRecognizer', 'SPPS_Modifier', 'SpeechRunState',
    'SpeechGrammarTagDictation', 'SRSEIsSpeaking',
    'eWORDTYPE_DELETED', 'SPCONTEXTSTATE', 'ISpeechAudioBufferInfo',
    'DISPID_SDKEnumKeys', 'SPCT_SLEEP', 'ISpeechPhraseReplacement',
    'DISPID_SRRAudioFormat', 'SPPS_Noun', 'DISPID_SPEPronunciation',
    'SGLexical', 'SPAUDIOOPTIONS', '_RemotableHandle',
    'SPEI_SR_BOOKMARK', '__MIDL_IWinTypes_0009', 'SVF_None',
    'SVF_Emphasis', 'SAFTCCITT_uLaw_44kHzMono', 'SFTInput',
    'SVSFParseSsml', 'DISPID_SVRate',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRRGetXMLErrorInfo',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_SENTENCE_BOUNDARY',
    'SRSActiveAlways', 'DISPID_SVSLastStreamNumberQueued',
    'ISpeechPhoneConverter', 'ISpeechLexiconPronunciation',
    'DISPID_SRAudioInputStream', 'SSFMOpenForRead', 'DISPID_SAVolume',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVDisplayUI', 'SVP_19',
    'SpeechDiscardType', 'SPEI_PROPERTY_NUM_CHANGE', 'SPLO_DYNAMIC',
    'ISpeechGrammarRule', 'DISPID_SWFEChannels',
    'DISPID_SRCRecognizer', 'SAFTADPCM_11kHzStereo',
    'SAFTADPCM_44kHzMono', 'DISPID_SPRuleConfidence', 'SVSFParseSapi',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVSkip', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechRecoResult', 'SpeechRecognizerState',
    'DISPID_SRCCreateGrammar', 'DISPID_SRCVoice',
    'DISPID_SMSAMMHandle', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPRNumberOfElements', 'SGRSTTEpsilon',
    'SAFT16kHz8BitMono', 'SAFT32kHz16BitStereo',
    'ISpeechPhraseProperties', 'SVP_2',
    'DISPID_SRCEPropertyStringChange', 'SPPS_Function',
    'SpeechGrammarRuleStateTransitionType',
    'SpeechCategoryRecognizers', 'DISPID_SLPsCount', 'SGRSTTRule',
    'DISPID_SpeechLexiconWord', 'SDTLexicalForm',
    'DISPID_SRCEAdaptation', 'SPEVENTSOURCEINFO', 'SVP_21',
    'SPRECOCONTEXTSTATUS', 'SPSEMANTICFORMAT',
    'SpeechRegistryLocalMachineRoot', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpPhrase',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SASFreeBufferSpace',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCCreateResultFromMemory', 'SDA_No_Trailing_Space',
    'SRAONone', 'SVSFVoiceMask', 'SDKLCurrentUser',
    'SpeechEngineProperties', 'ISpeechCustomStream',
    'SDKLDefaultLocation', 'SREPropertyStringChange',
    'SpUnCompressedLexicon', 'ISpLexicon', 'DISPID_SRCERequestUI',
    'SpeechTokenKeyFiles', 'SpeechInterference', 'SP_VISEME_20',
    'SVEEndInputStream', 'SINoSignal', 'DISPID_SGRSTsCount',
    'DISPID_SGRName', 'DISPID_SPPParent', 'SPFM_OPEN_READONLY',
    'eLEXTYPE_APP', 'SPSLMA', 'DISPID_SPEAudioStreamOffset',
    'eLEXTYPE_VENDORLEXICON', 'SAFTADPCM_8kHzStereo',
    'SPEI_END_SR_STREAM', 'DISPID_SpeechRecoResult2', 'SVP_5',
    'DISPID_SGRsFindRule', 'DISPID_SLPType', 'SPWAVEFORMATTYPE',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE5', 'SPEI_RECOGNITION',
    'SVSFParseAutodetect', 'ISpRecoResult', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SWFEExtraData', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVAudioOutputStream', 'SpeechTokenKeyUI', 'SITooQuiet',
    'SREStreamStart', 'SPWT_DISPLAY', 'DISPID_SRGSetTextSelection',
    'SVESentenceBoundary', 'eLEXTYPE_USER_SHORTCUT',
    'Speech_Default_Weight', 'DISPID_SPIGrammarId', 'SRERecognition',
    'SECLowConfidence', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCRequestedUIType', 'DISPID_SOTsCount', 'SpFileStream',
    'DISPID_SVStatus', 'SINoise', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE8',
    'DISPID_SWFESamplesPerSec', 'SPEI_INTERFERENCE', 'SPCT_DICTATION',
    'ISpMMSysAudio', 'DISPID_SOTCEnumerateTokens', 'SREStreamEnd',
    'SREInterference', 'SpeechRegistryUserRoot', 'DISPID_SPIRule',
    'DISPID_SRRecognizer', 'DISPID_SRGCmdLoadFromMemory',
    'DISPIDSPTSI_ActiveOffset', 'SpeechDisplayAttributes',
    'DISPID_SBSRead', 'SECFIgnoreWidth',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SGRSAddWordTransition',
    'SRTExtendableParse', 'SAFT8kHz8BitMono', 'SREAllEvents',
    'SP_VISEME_16', 'DISPID_SVSInputSentenceLength',
    'SDTPronunciation', 'SPSHT_EMAIL', 'SAFT16kHz16BitMono',
    'ISpeechRecoGrammar', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SGRsCommitAndSave', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRIsShared', 'DISPID_SpeechObjectToken',
    'SPDKL_CurrentConfig', 'SPPS_NotOverriden',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechPropertyLowConfidenceThreshold',
    'ISpeechVoice', 'SRARoot', 'SPFM_NUM_MODES', 'SPVPRI_ALERT',
    'DISPID_SVSpeakStream', 'SPAR_Unknown',
    'DISPID_SREmulateRecognition', 'DISPID_SGRs_NewEnum',
    'ISpeechRecoResultTimes', 'SVP_7', 'SRSActive',
    'eLEXTYPE_MORPHOLOGY', 'SPAO_NONE', 'SpeechBookmarkOptions',
    'SPFM_CREATE', 'SPAS_RUN', 'SRAImport', 'DISPID_SPEAudioSizeTime',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPCPhoneToId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SVEWordBoundary', 'SP_VISEME_0', 'SAFT8kHz8BitStereo',
    'SpeechCategoryAppLexicons', 'DISPID_SPRulesItem',
    'SPINTERFERENCE_TOOSLOW', 'SPTEXTSELECTIONINFO',
    'SAFT12kHz8BitMono', 'SPBO_TIME_UNITS', 'DISPID_SAFType',
    'SpSharedRecognizer', 'DISPID_SRCBookmark', 'SPEI_MAX_TTS',
    'SAFTGSM610_22kHzMono', 'SVP_13', 'SECHighConfidence', 'SVP_12',
    'DISPID_SRGDictationUnload', 'SPRST_NUM_STATES',
    'DISPID_SVSPhonemeId', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpResourceManager', 'DISPID_SVResume', 'SPSERIALIZEDPHRASE',
    'SP_VISEME_5', 'ISpDataKey', 'SPAS_PAUSE', 'SPWORDPRONUNCIATION',
    'SpeechRecoProfileProperties', 'SAFTCCITT_uLaw_22kHzMono',
    'SASStop', 'SASRun', 'SPAS_CLOSED', 'UINT_PTR',
    'DISPID_SRGetRecognizers', 'SECFIgnoreKanaType',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRSClsidEngine',
    'SPBO_NONE', 'DISPID_SpeechPhoneConverter', 'SPGS_ENABLED',
    'SPBO_PAUSE', 'SPEI_TTS_BOOKMARK', 'SDTProperty',
    'SpInProcRecoContext', 'SPXRO_Alternates_SML',
    'SpeechPropertyNormalConfidenceThreshold', 'SPSERIALIZEDRESULT',
    'SPRECOGNIZERSTATUS', 'SP_VISEME_13', 'DISPID_SPEAudioSizeBytes',
    'SPSMF_UPS', 'SVP_16', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRuleEngineConfidence', 'SREBookmark',
    'ISpeechPhraseReplacements', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVGetProfiles', 'DISPID_SPIElements',
    'ISpeechPhraseProperty', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SLPs_NewEnum', 'ISpVoice', 'SpeechTokenIdUserLexicon',
    ...
    'SPGS_EXCLUSIVE', 'SPPHRASEPROPERTY', 'DISPID_SRCEEndStream',
    'STSF_AppData', 'DISPID_SVEVoiceChange', 'SRSEDone', 'SPEVENT',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE13', 'SVP_9',
    'DISPID_SOTGetStorageFileName', 'SpeechAllElements',
    'SPSHT_OTHER', 'SpNotifyTranslator',
    'DISPID_SRCEFalseRecognition', 'SAFT22kHz8BitStereo',
    'STSF_CommonAppData', 'ISpGrammarBuilder', 'SpeechLexiconType',
    'eLEXTYPE_PRIVATE11', 'SPEI_TTS_AUDIO_LEVEL', 'SPEI_PHRASE_START',
    'ISpeechLexiconWords', 'DISPID_SVEBookmark',
    'DISPID_SpeechPhraseInfo',
    'DISPID_SRCERecognitionForOtherContext', 'SRERequestUI',
    'SREPrivate', 'DISPID_SpeechCustomStream', 'SpeechUserTraining',
    'DISPID_SRGDictationLoad', 'SSFMOpenReadWrite',
    'DISPID_SRGSetWordSequenceData', 'SAFTGSM610_11kHzMono',
    'DISPID_SRCState', 'DISPID_SpeechLexiconProns', 'SPLO_STATIC',
    'LONG_PTR', 'SVSFPurgeBeforeSpeak', 'SSSPTRelativeToEnd',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SMSADeviceId',
    'DISPID_SPPEngineConfidence', 'DISPID_SVEEnginePrivate',
    'DISPID_SAStatus', 'SPBOOKMARKOPTIONS', 'SSFMCreate',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRRAlternates',
    'SDA_Two_Trailing_Spaces', 'SWTDeleted', 'eLEXTYPE_PRIVATE20',
    'SpeechPropertyResourceUsage', 'IInternetSecurityMgrSite',
    'DISPIDSPTSI_SelectionLength', 'ISpRecognizer3', 'SAFTText',
    'SREFalseRecognition', 'SAFT44kHz16BitStereo', 'SPCT_SUB_COMMAND',
    'SpObjectTokenCategory', 'SVSFNLPMask', 'SPWORDLIST',
    'SPCS_DISABLED', 'SpeechCategoryPhoneConverters',
    'SPEI_TTS_PRIVATE', 'SPEI_UNDEFINED', 'DISPID_SPPFirstElement',
    'DISPID_SPRuleId', 'SPPARTOFSPEECH',
    'DISPID_SpeechPhraseProperties', 'SVP_4',
    'DISPID_SVSyncronousSpeakTimeout', 'SVP_10', 'DISPID_SPCLangId',
    'SpeechCategoryAudioIn', 'DISPID_SOTMatchesAttributes',
    'ISpeechPhraseRules', 'SP_VISEME_11', 'DISPID_SPRuleParent',
    'DISPID_SWFEBitsPerSample', 'SPRULESTATE',
    'SPINTERFERENCE_TOOQUIET', 'SPFM_CREATE_ALWAYS',
    'DISPID_SVSInputSentencePosition', 'SPAR_Medium',
    'DISPID_SRGCmdLoadFromObject', 'SPEI_WORD_BOUNDARY',
    'SREStateChange', 'SPEI_VISEME', 'DISPID_SRRSpeakAudio',
    'DISPID_SVEventInterests', 'SPAUDIOBUFFERINFO',
    'DISPID_SPRuleFirstElement', 'ISpNotifySource', 'SPRST_INACTIVE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPAUDIOSTATE',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPANumberOfElementsInResult',
    'SRESoundStart', 'SpeechAudioFormatType',
    'DISPID_SASNonBlockingIO', 'SRSInactive',
    'DISPID_SVSInputWordPosition', 'IStream', 'SVSFNLPSpeakPunc',
    'SBOPause', 'SPWORDTYPE', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechWaveFormatEx', 'SAFTADPCM_22kHzMono',
    'eLEXTYPE_USER', 'DISPID_SVEAudioLevel',
    'DISPID_SOTCreateInstance', 'DISPID_SRCEAudioLevel', 'ISpAudio',
    'SGSExclusive', 'ISpRecoCategory', 'SPDKL_LocalMachine',
    'ISpeechRecoResult', 'SVP_14', 'DISPID_SABIBufferSize',
    'SP_VISEME_7', 'DISPID_SpeechAudioFormat', 'SINone',
    'SPPHRASEELEMENT', 'SAFTADPCM_8kHzMono', 'SpVoice', 'SP_VISEME_9',
    'SLTUser', 'IEnumSpObjectTokens', 'SPWORDPRONOUNCEABLE',
    'SAFT11kHz8BitStereo', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SDKDeleteKey', 'SPEI_RESERVED1',
    'DISPID_SpeechPhraseBuilder', 'SGRSTTDictation', 'SVEAllEvents',
    'DISPID_SpeechXMLRecoResult', 'SpAudioFormat',
    'ISpeechRecoResult2', 'SAFTGSM610_8kHzMono', 'SRATopLevel',
    'DISPID_SPIProperties', 'SPVPRIORITY',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVPause',
    'DISPID_SpeechRecoContextEvents', 'SAFT11kHz8BitMono',
    'SWPUnknownWordPronounceable', 'ISpObjectWithToken', 'SRTReSent',
    'SRADefaultToActive', 'eLEXTYPE_PRIVATE10',
    'ISpeechObjectTokenCategory', 'DISPID_SPIGetDisplayAttributes',
    'SAFTADPCM_22kHzStereo', 'DISPID_SDKSetBinaryValue',
    'DISPID_SGRSAddSpecialTransition', 'SP_VISEME_17',
    'eLEXTYPE_PRIVATE17', 'eLEXTYPE_PRIVATE18', 'SPSNotOverriden',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SOTRemove',
    'DISPID_SRRRecoContext', 'DISPID_SDKOpenKey',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRCEInterference',
    'DISPID_SBSFormat', 'DISPID_SRSAudioStatus', 'DISPID_SVEWord',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPIAudioSizeTime', 'ISpeechLexiconPronunciations',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRGRules', 'DISPID_SGRSTWeight',
    'SPEI_RESERVED2', 'ISpStreamFormatConverter', 'DISPID_SOTsItem',
    'DISPID_SLGetPronunciations', 'DISPID_SLWLangId',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRGRecoContext',
    'SPDKL_DefaultLocation', 'DISPID_SRRSetTextFeedback',
    'DISPID_SABufferInfo', 'SpeechMicTraining',
    'DISPID_SASCurrentSeekPosition', 'SASClosed',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_PRIVATE14', 'DISPID_SGRsCount',
    'SPRECORESULTTIMES', 'DISPID_SPEActualConfidence',
    'DISPID_SRCEStartStream', 'SRAExport',
    'SpeechGrammarTagUnlimitedDictation', 'IInternetSecurityManager',
    'DISPID_SVGetAudioInputs', 'SAFT44kHz8BitStereo', 'SDTRule',
    'DISPID_SGRSTPropertyId', 'SAFTADPCM_11kHzMono', 'SBONone',
    'DISPID_SLWsCount', 'SPBINARYGRAMMAR', 'DISPID_SRRTLength',
    'DISPID_SVSLastBookmark', 'SAFT12kHz16BitStereo',
    'SpeechCategoryRecoProfiles', 'SPWT_LEXICAL', 'SGSEnabled',
    'DISPID_SPRuleName', 'SpeechEngineConfidence', 'SPEI_SOUND_END',
    'SPEI_FALSE_RECOGNITION', 'SpTextSelectionInformation',
    'SPCS_ENABLED', 'SSTTTextBuffer', 'SRSInactiveWithPurge',
    'DISPID_SRRGetXMLResult', 'DISPID_SOTs_NewEnum', 'DISPID_SGRsAdd',
    'DISPID_SOTSetId', 'SPSVerb', 'SVSFIsFilename', 'SPRST_ACTIVE',
    'SP_VISEME_2', 'SPSHORTCUTTYPE', 'SpeechAudioVolume',
    'DISPID_SRRTStreamTime', 'DISPID_SRCERecognition', 'ISpShortcut',
    'SpeechVoiceSpeakFlags', 'SAFT11kHz16BitMono', 'DISPID_SVVolume',
    'SVEPhoneme', 'SpeechTokenKeyAttributes', 'SVP_3',
    'DISPID_SpeechVoiceStatus', 'DISPID_SOTIsUISupported',
    'IEnumString', 'DISPID_SpeechPhraseElements',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPPNumberOfElements',
    'SPINTERFERENCE_NONE', 'DISPID_SVSLastBookmarkId',
    'SpeechLoadOption', 'SAFT48kHz16BitStereo', 'SAFT16kHz8BitStereo',
    'SpPhraseInfoBuilder', 'SP_VISEME_3', 'ISpObjectTokenCategory',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRSCurrentStreamNumber', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPFM_OPEN_READWRITE', 'ISpNotifyTranslator', 'SPEI_PHONEME',
    'SRAInterpreter', 'SPSUnknown', 'SVP_8',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'tagSTATSTG',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRCEBookmark',
    '_ISpeechVoiceEvents', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEEnginePrivate', 'SRESoundEnd', 'eLEXTYPE_PRIVATE3',
    'DISPID_SMSSetData', 'DISPID_SRCESoundEnd', 'SLTApp', 'SVP_6',
    'SPPS_RESERVED3', 'SpeechEmulationCompareFlags',
    'DISPID_SGRSRule', 'DISPID_SPRFirstElement', 'DISPID_SFSClose',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT32kHz8BitMono',
    'SpWaveFormatEx', 'SPVPRI_NORMAL', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechLexicon', 'SPEI_RECO_OTHER_CONTEXT', 'SPSFunction',
    'DISPID_SDKCreateKey', 'DISPID_SLWWord',
    'SPINTERFERENCE_LATENCY_WARNING', 'SITooSlow',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SWFEBlockAlign',
    'SGPronounciation', 'SpMMAudioEnum',
    'DISPID_SVSpeakCompleteEvent', 'SpeechGrammarState',
    'STCInprocServer', 'DISPID_SpeechFileStream', 'SPEI_SOUND_START',
    'DISPID_SGRSTText', 'DISPID_SDKGetStringValue',
    'SpCompressedLexicon', 'SpeechSpecialTransitionType',
    'SVEStartInputStream', 'SpeechRecoEvents',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SOTDisplayUI',
    'DISPID_SRCEventInterests', 'SAFT48kHz16BitMono',
    'DISPID_SRCSetAdaptationData', 'SPPS_Unknown',
    'DISPID_SpeechPhraseReplacements', 'ISpPhoneticAlphabetConverter',
    'SPRS_INACTIVE', 'SPPS_LMA', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPWF_INPUT', 'DISPID_SGRInitialState', 'DISPID_SVSRunningState',
    'ISpeechObjectToken', 'DISPID_SPISaveToMemory', 'SPVOICESTATUS',
    'DISPID_SCSBaseStream', 'ISpeechAudio', 'SpeechAudioState',
    'SDTReplacement', 'SpeechRecoContextState',
    'DISPID_SpeechPhraseAlternate', 'SpShortcut', 'SVSFlagsAsync',
    'DISPID_SpeechAudio', 'SAFT24kHz8BitMono',
    'SpeechRecognitionType', 'DISPID_SFSOpen',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRIsUISupported',
    'SPBO_AHEAD', 'SpeechTokenContext', 'SpPhoneticAlphabetConverter',
    'DISPID_SOTGetAttribute', 'SpeechDataKeyLocation',
    'SPAUDIOSTATUS', 'SP_VISEME_8', 'SPCT_SUB_DICTATION',
    'SGRSTTWildcard', 'DISPIDSPTSI_ActiveLength', 'DISPID_SASetState',
    'SP_VISEME_4', 'SDA_One_Trailing_Space', 'SVF_Stressed',
    'DISPID_SRCESoundStart', 'DISPID_SGRSTNextState', 'SPAR_Low',
    'SpeechRuleAttributes', 'SREAudioLevel', 'Speech_StreamPos_Asap',
    'SECFEmulateResult', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SPPName',
    'SWPKnownWordPronounceable', 'ISpeechGrammarRules',
    'DISPID_SADefaultFormat', 'SDTAll',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPCIdToPhone',
    'SPPS_Verb', 'DISPID_SOTCSetId', 'SPEI_VOICE_CHANGE',
    'Speech_Max_Word_Length', 'SPSHORTCUTPAIR',
    'ISpeechGrammarRuleStateTransition', 'SVEBookmark', 'DISPIDSPRG',
    'DISPID_SPRsCount', 'DISPID_SPRulesCount', 'DISPID_SPPsCount',
    'DISPID_SPACommit', 'DISPID_SGRsItem', 'DISPID_SDKSetLongValue',
    'DISPID_SPPValue', 'SPPROPERTYINFO', 'SpeechWordType',
    'DISPID_SpeechAudioStatus', 'DISPID_SPIEngineId',
    'DISPID_SVEPhoneme', 'SpMMAudioOut', 'SpeechAudioFormatGUIDText',
    'STCRemoteServer', 'DISPID_SPEDisplayAttributes',
    'ISpeechPhraseAlternates', 'ISpEventSink', 'ISpeechRecognizer',
    'DISPID_SRGetFormat', 'SPCT_COMMAND', 'DISPID_SPEsCount',
    'SPSModifier', 'DISPID_SVAlertBoundary', 'DISPID_SGRsDynamic',
    'SVP_15', 'SRADynamic', 'DISPID_SPRuleNumberOfElements',
    'SAFT22kHz16BitStereo', 'SPSMF_SAPI_PROPERTIES',
    'eWORDTYPE_ADDED', 'ISpSerializeState', 'SVP_0',
    'ISpeechPhraseElement', 'SPSTREAMFORMATTYPE',
    'DISPID_SDKEnumValues', 'SPEI_MIN_TTS'
]

_check_version('1.1.14', 1633527515.941447)
